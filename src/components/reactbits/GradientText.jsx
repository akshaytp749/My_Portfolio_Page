...
export default function GradientText({
  ...
  return (
    <motion.div
      className={`relative inline-flex max-w-fit flex-row items-center rounded-[1.25rem] font-medium overflow-hidden align-baseline ${showBorder ? 'py-1 px-2' : ''} ${className}`}
